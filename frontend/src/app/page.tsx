    ...
    <div className="flex items-center justify-center min-h-screen p-4">
      <div className="glass-panel rounded-2xl p-8 w-full max-w-md relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Track your daily emotional states</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-medium py-3 rounded-xl transition-all shadow-lg shadow-purple-900/20 flex items-center justify-center gap-2"
          >
            <LogIn size={18} />
            Continue
          </button>
